...
public class MainActivity extends Activity 
{
   ...
   private TextView avgPayStandard;
   private TextView avgPayCustom;
   ...
   protected void onCreate(Bundle savedInstanceState)
   {
      ...
      NumberTextView = 
    	         (TextView) findViewById(R.id.textViewNum);
      avgPayStandard = 
    	         (TextView) findViewById(R.id.avgStandTextView);
      avgPayCustom = 
    	         (TextView) findViewById(R.id.avgCustomTextView);
   ...
   private void updateStandard() 
   {
      ...
      avgPayStandard.setText(currencyFormat.format(fifteenPercentTotal/persons));
   ...
   private void updateCustom() 
   {
      ...
      avgPayCustom.setText(currencyFormat.format(customTotal/persons));
